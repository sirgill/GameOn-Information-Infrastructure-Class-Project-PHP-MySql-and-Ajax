    ...
    static public function displayHeader($page_title) {
        ...
        <html>
            ...
            <body id="space">
                ...
                <div id='wrapper'>
                    <div id="banner">
                        <a href="<?= BASE_URL ?>/index.php" style="text-decoration: none" title="GAMEON Library">
                            <div id="left">
                                <img src='<?= BASE_URL ?>/www/img/Game.png' style="width: 180px; border: none" />
                ...
                <div id="footer"><br>&copy 2016 GAMEON . All Rights Reserved.</div>
